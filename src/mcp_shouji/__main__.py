...
此檔案允許套件透過 `python -m mcp_shouji` 執行。

使用方法:
  python -m mcp_shouji        # 啟動 MCP 伺服器
  python -m mcp_shouji test   # 執行測試
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="MCP Shouji - 跨平台交互式反馈工具"
    )
...
#### 連結和引用
- 專案連結：[MCP Shouji](https://github.com/f/mcp-shouji)
        ...
        try:
            ...
            def import_desktop_app():
                ...
                if os.path.exists(tauri_python_path):
                    ...
                    try:
                        from mcp_shouji_desktop import (  # type: ignore
            ...
            if launch_desktop_app_func is None:
                ...
                print("   3. Web 模式指令：uvx mcp-shouji test --web")
                return False
...
def show_version():
    ...
    print(f"MCP Shouji v{__version__}")
    print(f"作者: {__author__}")
    print("GitHub: https://github.com/f/mcp-shouji")
