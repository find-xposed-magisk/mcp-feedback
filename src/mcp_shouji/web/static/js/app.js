...
(function() {
    ...
    FeedbackApp.prototype.init = function() {
        ...
        console.log('🚀 初始化 MCP Shouji 應用程式');
            ...
            try {
                ...
                self.waitForI18n()
                    ...
                    .then(function() {
                        ...
                        console.log('✅ MCP Shouji 應用程式初始化完成');
                        resolve();
                    })
    ...
    FeedbackApp.prototype.refreshPageContent = function() {
        ...
        fetch('/api/current-session')
            ...
            .then(function(sessionData) {
                ...
                // 更新摘要內容
                if (self.uiManager) {
                    // console.log('🔧 準備更新摘要內容，summary 長度:', sessionData.summary ? sessionData.summary.length : 'undefined');
                    self.uiManager.updateSummaryContent(sessionData.summary);
            ...
            .catch(function(error) {
                ...
                const updateFailedMessage = window.i18nManager ? window.i18nManager.t('app.updateFailed') : '更新內容失敗，請手動刷新頁面以查看新的工作摘要';
