...
(function() {
     ...
     * 獲取摘要
     */
    SessionManager.prototype.getSummary = function() {
        const summaryElement = document.querySelector('.session-summary');
        if (summaryElement && summaryElement.textContent !== '摘要: 載入中...') {
            return summaryElement.textContent.replace('摘要: ', '');
        }
