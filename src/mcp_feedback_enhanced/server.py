...
async def interactive_feedback(
    ...
    timeout: Annotated[int, Field(description="等待用戶回饋的超時時間（秒），可通過 MCP_DEFAULT_TIMEOUT 環境變數設定預設值")] = None,
) -> list:
    ...
    # Handle timeout default value (supports MCP_DEFAULT_TIMEOUT env var)
    if timeout is None:
