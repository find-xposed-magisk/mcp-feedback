...
def extract_backend_codes():
    ...
    message_codes_file = Path(
        "src/mcp_shouji/web/constants/message_codes.py"
    )
...
def extract_frontend_codes():
    ...
    message_codes_js = Path(
        "src/mcp_shouji/web/static/js/modules/constants/message-codes.js"
    )
    ...
    utils_js = Path("src/mcp_shouji/web/static/js/modules/utils.js")
    if utils_js.exists():
...
def extract_translation_keys(locale="zh-TW"):
    ...
    translation_file = Path(
        f"src/mcp_shouji/web/locales/{locale}/translation.json"
    )
