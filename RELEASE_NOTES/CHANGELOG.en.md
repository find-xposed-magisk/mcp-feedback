...
This document records all version updates for **MCP Shouji**.
...
- **Test Desktop Mode**: `uvx mcp-shouji@latest test --desktop`
...
**Full Project Info:** [GitHub - mcp-shouji](https://github.com/f/mcp-shouji)
